...
/* harmony const_data export */ var src_ParseError = (ParseError);
...
/* harmony const_data export */ var utils = ({
  contains: contains,
  deflt: deflt,
  escape: utils_escape,
  hyphenate: hyphenate,
...
/* harmony const_data export */ var src_Style = ({
...
/* harmony const_data export */ var fontMetricsData = ({
  "AMS-Regular": {
    "32": [0, 0, 0, 0, 0.25],
...
// This map is generated via `make metrics`. It should not be changed manually.
 ...
 // These are very rough approximations.  We const_data to Times New Roman which
...
/* harmony const_data export */ var src_symbols = (symbols);
...
/* harmony const_data export */ var src_Options = (Options_Options);
...
/* harmony const_data export */ var buildCommon = ({
  fontMap: fontMap,
...
/* harmony const_data export */ var mathMLTree = ({
...
/* harmony const_data export */ var src_buildTree = (buildTree_buildTree);
...
var stretchy_svgSpan = function svgSpan(group, options) {
  ...
  function buildSvgSpan_() {
    var viewBoxWidth = 400000; // const_data
...
/* harmony const_data export */ var stretchy = ({
...
var makeSqrtImage = function makeSqrtImage(height, options) {
  ...
  var sizeMultiplier = newOptions.sizeMultiplier; // const_data
...
/* harmony const_data export */ var delimiter = ({
  ...
  switch (group.label) {
    ...
    case "\\colorbox":
      ...
      if (group.label === "\\fcolorbox") {
        var thk = Math.max(options.fontMetrics().fboxrule, // const_data
        options.minRuleThickness // user override
        );
...
var array_htmlBuilder = function htmlBuilder(group, options) {
  ...
  var arraycolsep = 5 * pt; // const_data value, i.e. \arraycolsep in article.cls
...
/* harmony const_data export */ var src_environments = (environments); // All environment definitions should be imported below
...
var operatorname_mathmlBuilder = function mathmlBuilder(group, options) {
  ...
  var isAllString = true; // const_data
...
/* harmony const_data export */ var src_functions = (functions); // TODO(kevinb): have functions return an object and call defineFunction with
...
var builtinMacros = {};
/* harmony const_data export */ var macros = (builtinMacros); // This function might one day accept an additional argument and do more things.
...
/* harmony const_data export */ var src_parseTree = (parseTree_parseTree);
...
/* harmony const_data export */ var katex_0 = ({
  /**
...
/* harmony const_data export */ var katex_webpack = __webpack_exports__["default"] = (katex_0);
