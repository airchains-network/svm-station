...
1. Create the new validator identity keypair, `stationsvm-keygen new -o ~/new-validator-keypair.json`.
...
2. Create the new vote authority keypair, `stationsvm-keygen new -o ~/new-vote-authority.json`.
