...
You can generate a custom vanity keypair using station-svm-keygen. For instance:

```bash
station-svm-keygen grind --starts-with e1v1s:1
```
...
```bash
station-svm-keygen grind --use-mnemonic --starts-with e1v1s:1
```
