...
```bash
stationsvm-keygen pubkey usb://ledger
```
...
To view any address, use the `stationsvm-keygen pubkey` command, as shown below,
...
```bash
stationsvm-keygen pubkey usb://ledger
stationsvm-keygen pubkey usb://ledger?key=0
stationsvm-keygen pubkey usb://ledger?key=1
stationsvm-keygen pubkey usb://ledger?key=2
```
...
```bash
~$ stationsvm-keygen pubkey usb://ledger?key=42
