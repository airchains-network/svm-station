...
```bash
station-svm-keygen pubkey usb://ledger
```
...
To view any address, use the `station-svm-keygen pubkey` command, as shown below,
...
```bash
station-svm-keygen pubkey usb://ledger
station-svm-keygen pubkey usb://ledger?key=0
station-svm-keygen pubkey usb://ledger?key=1
station-svm-keygen pubkey usb://ledger?key=2
```
...
```bash
~$ station-svm-keygen pubkey usb://ledger?key=42
